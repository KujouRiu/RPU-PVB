...
class FunctionNegativeTripletSelector(TripletSelector):
    """
    For each positive pair, takes the hardest negative sample (with the greatest circle loss value) to create a circle
    Margin should match the margin used in circle loss.
...
def HardestNegativeTripletSelector(margin, cpu=False, **kwargs): return FunctionNegativeTripletSelector(margin=margin,
...
def SemihardNegativeTripletSelector(margin, cpu=False, **kwargs): return FunctionNegativeTripletSelector(margin=margin,
